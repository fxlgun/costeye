...
function CategoryRadio({ setEyeData, eyeData }) {
    const options = ['Amazon', 'Flipkart']

    const { getRootProps, getRadioProps } = useRadioGroup({
        name: 'category',
        defaultValue: 'Amazon',
        onChange: (value) => setEyeData({ ...eyeData, category: value }),
    })
            ...
            {options.map((value) => {
                ...
                return (
                    <RadioCard key={value} {...radio}>
                        {value === 'Amazon' ? <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                        ...
                        </svg> : <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 100 100">
